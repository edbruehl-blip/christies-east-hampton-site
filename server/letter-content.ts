...
It started with a conviction. Ed always knew a moment would come when he would build something like Christie's, and walk this land the way Frank Newbold did. Frank Newbold is Ed's mentor at Sotheby's East Hampton — 45 years in this market, still fully active, still producing, one of the most respected brokers on the East End. He taught Ed how to behave and act in this space. Any broker who knows the territory knows the name. Watching Christie's East Hampton operate below its potential, he recognized the moment. A lunch with Ilija Pavlovic at Rockefeller Center made it real. Ed brought a document: the Christie's East Hampton flagship business plan drafted with Claude and ChatGPT. That document is what Ilija agreed to. That conversation is what started this entire project. The business model became spreadsheets. The spreadsheets became a dashboard. The dashboard became an institutional operating system.
