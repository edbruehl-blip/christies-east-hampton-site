        ...
        <div style="padding: 40px;">
          ...
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #D3D1C7;">
            ...
            <p style="color: #1B2A4A; font-size: 14px; line-height: 1.7; margin: 0;">
              The South Fork is not a market. It is a territory — ten distinct hamlets, each with its own character, its own price corridor, its own buyer. Christie's East Hampton carries the standard that James Christie established in 1766: the family's interest comes before the sale.
            </p>
