...
We are telling you this story because you are part of it. Not as an observer. As someone whose honest read on this system matters to how it grows. Tell us what resonates. Tell us what falls short. Tell us what you see that we have not thought of yet. This office was built for East Hampton, but the Christie's international network is wide, and the same model that works here can serve families in communities around the world. We are grateful you are in this chapter with us. And we look forward to building the next one together.`;
