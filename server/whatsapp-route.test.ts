...
function buildMorningBrief(dateStr: string): string {
  return (
    ...
    `The Hamptons luxury market continues to show resilience across all eleven hamlets. ` +
...
describe("William WhatsApp — morning brief", () => {
  ...
  it("mentions all eleven hamlets context", () => {
    const text = buildMorningBrief("Monday, March 31, 2026");
    expect(text).toContain("eleven hamlets");
  });
