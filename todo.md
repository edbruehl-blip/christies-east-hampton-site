...
- [x] MARKET PDF export button: SKIPPED — Sprint 14 doctrine stands (/report is sole PDF export path)
...
- [x] Change 2: FlagshipLetterPage — ?person= routing implemented (synchronous useState initializer, angel/jarvis/default variants)
- [x] Trello: Add Jarvis Slade card to FLAGSHIP TEAM list — done by Perplexity (card #176)

## P1 Items — Before April 29 Relaunch

- [x] Headcount footnote: updated to "12 elite producers per office · Cap intentional · Recruiting engine dormant 2031" (Perplexity 6f194fd)
