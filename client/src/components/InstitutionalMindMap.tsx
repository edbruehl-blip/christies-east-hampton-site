...
const NODES: MapNode[] = [
  ...
  { id: "exports",
    ...
    type: "RELATIONSHIP_INTELLIGENCE", status: "ACTIVE",
    note: "All PDF exports generated by the platform. Market · Advisory · Recruiting · Collateral. Hover sub-nodes (coming Sprint 15): Market Report, Christie's Letter, Hamlet PDFs ×11, ANEW Build Memo, Christie CMA, Deal Brief, Investment Memo, UHNW Path Card, FUTURE Pro Forma.",
    x: 640, y: 1060, r: 18 },
