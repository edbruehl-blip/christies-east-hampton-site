...
export const FOUNDING_PARAGRAPHS: string[] = [
  ...
  "I am honored to be Managing Director of Christie's International Real Estate Group, East Hampton Flagship, at 26 Park Place. This flagship sits at the intersection of three worlds: Christie's London heritage, our Rockefeller Center auction house in New York City, and the Hamptons, one of the most significant luxury markets on earth. Spanning nearly 50 countries and territories, the team we're assembling is built on one standard: service first, your interests first, always.",
